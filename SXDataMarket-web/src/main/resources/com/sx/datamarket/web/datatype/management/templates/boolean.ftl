									...
									<div aria-labelledby="${controlName}Header" class="in  " id="${controlName}Content" role="presentation">
										<div class="panel-body">
											<div style="display:inline-block; margin-left:10px; margin-right:10px;">
												<div class="radio">
													<label for="${controlName}_true}">
														<input 
																checked
																class="field" 
																id="${controlName}_true" 
																name="${controlName}" 
																type="radio" 
																value="true">
														${trueLabel}
												...
												<script>
	<#if renderType == PREVIEW >
													$('#${controlName}_true}').click(function(event){
											...
											<div style="display:inline-block; margin-left:10px; margin-right:10px;">
												<div class="radio">
													<label for="${controlName}_false}">
														<input 
																class="field" 
																id="${controlName}_false" 
																name="${controlName}" 
																type="radio" 
																value="true">
														${falseLabel}
												...
												<script>
	<#if renderType == PREVIEW >
													$('#${controlName}_false}').click(function(event){
														let selectedValue = $(this).val();
