...
<#if renderType == PREVIEW >
	...
	<#elseif displayStyle == "radio">
						<div class="card-horizontal main-content-card">
							<div aria-multiselectable="true" class="panel-group" role="tablist">
								<fieldset aria-labelledby="listDisplayStyleTitle" role="group">
									<div class="panel-heading" id="${controlName}Header" role="presentation">
										<div class="panel-title" id="${controlName}Title">
											${label}
		<#if helpMessage?has_content>
											<span class="taglib-icon-help lfr-portal-tooltip" title="${helpMessage}">
												<span>
									...
									<div aria-labelledby="${controlName}Header" class="in  " id="${controlName}Content" role="presentation">
										<div class="panel-body">
		<#list options as option>
											<div style="display:inline-block; margin-left:10px; margin-right:10px;">
												<div class="radio">
													<label for="${controlName}_${option?counter}">
														<input 
			<#if option.selected == true>
																checked
			</#if> 
																class="field" 
																id="${controlName}_${option?counter}" 
																name="${controlName}" 
																type="radio" 
																value="${option.value}">
														${option.label}
	...
	<#elseif displayStyle == "check">
						<div class="card-horizontal main-content-card">
							<div aria-multiselectable="true" class="panel-group" role="tablist">
								<fieldset aria-labelledby="${controlName}Title" role="group">
									<div class="panel-heading" id="'${controlName}Header" role="presentation">
										<div class="panel-title" id="${controlName}Title">
											${label}
		<#if helpMessage?has_content>
		...
		<#list options as option>
			...
			<#if option.selected == true>
											...
											<script>
												$('#${controlName}_${option?counter}').change(function(event){
													$.alert("The value of the checkbox ${label} is " + $(this).val());
												});
											</script>
		</#list>
										</div>
